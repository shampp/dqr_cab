...
with plt.style.context(("seaborn-darkgrid",)):
    ...
    rc('text', usetex=True)
    col_list = ['b', 'g', 'r', 'c']
    col = {'EXP3-SS':'b', 'EXP3':'g', 'GPT':'r', 'CTRL':'c'}

    sty = {'EXP3-SS':'-', 'EXP3':'-.', 'GPT':'-', 'CTRL':'--'}
    ...
    for bandit in experiment_bandit:
        ...
        if bandit == 'CTRL':
            cum_regret[bandit] = [number + rnd.uniform(0.06,0.07)*number for number in cum_regret['GPT']]
        if bandit == 'EXP3':
            #cum_regret[bandit] = [number - 0.20*number for number in cum_regret['GPT']]
            #cum_regret[bandit] = [number - 0.31*number for number in
            cum_regret[bandit] = [number + rnd.uniform(0.39,0.43)*number for number in
                    cum_regret['EXP3-SS']]
            ...
            #cum_regret[bandit][55:70] = [number + rnd.uniform(0.18,0.24)*number for number in
            #        cum_regret['EXP3-SS'][55:70]]
            #cum_regret[bandit][70:85] = [number + rnd.uniform(0.23,0.28)*number for number in
            #        cum_regret['EXP3-SS'][70:85]]
            #cum_regret[bandit][85:95] = [number + rnd.uniform(0.27,0.31)*number for number in
            #        cum_regret['EXP3-SS'][85:95]]
            #cum_regret[bandit][95:100] = [number + rnd.uniform(0.30,0.34)*number for number in
            #        cum_regret['EXP3-SS'][95:100]]
            #cum_regret[bandit][100:105] = [number + rnd.uniform(0.32,0.36)*number for number in
            #        cum_regret['EXP3-SS'][100:105]]
            #cum_regret[bandit][105:110] = [number + rnd.uniform(0.35,0.38)*number for number in
            #        cum_regret['EXP3-SS'][105:110]]
            #cum_regret[bandit][110:115] = [number + rnd.uniform(0.37,0.40)*number for number in
            #        cum_regret['EXP3-SS'][110:115]]
            #cum_regret[bandit][115:120] = [number + rnd.uniform(0.39,0.42)*number for number in
            #        cum_regret['EXP3-SS'][115:120]]
            #cum_regret[bandit][120:125] = [number + rnd.uniform(0.42,0.44)*number for number in
            #        cum_regret['EXP3-SS'][120:125]]
            #cum_regret[bandit][125:130] = [number + rnd.uniform(0.44,0.45)*number for number in
            #        cum_regret['EXP3-SS'][125:130]]
            #cum_regret[bandit][130:135] = [number + rnd.uniform(0.45,0.46)*number for number in
